...
abstract class Notification {
  protected channeles: NotificationChannel[];
  
  constructor(channeles: NotificationChannel[]){
...
class AlertNotification extends Notification {
  ...
  override addChannel(channel: NotificationChannel): void {
    this.channeles.push(channel);
  }


  override notify(message: string): void {
    console.log('%cNotificacion de alerta: ', COLORS.red);
    this.channeles.forEach((channel)=> channel.send(message));
  }
